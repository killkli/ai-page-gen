import{G as z}from"./ai-vendor-ClgCF3w8.js";import{c as ee}from"./gemini-service-DqzV0kEP.js";import{L as te}from"./vendor-D6m3ha6S.js";const ne="modulepreload",re=function(s){return"/ai-page-gen/"+s},F={},M=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let a=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(d=>({status:"fulfilled",value:d}),d=>({status:"rejected",reason:d}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),c=o?.nonce||o?.getAttribute("nonce");r=a(t.map(l=>{if(l=re(l),l in F)return;F[l]=!0;const u=l.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${d}`))return;const g=document.createElement("link");if(g.rel=u?"stylesheet":ne,u||(g.as="script"),g.crossOrigin="",g.href=l,c&&g.setAttribute("nonce",c),document.head.appendChild(g),u)return new Promise((p,f)=>{g.addEventListener("load",p),g.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return r.then(a=>{for(const o of a||[])o.status==="rejected"&&i(o.reason);return e().catch(i)})},P="https://api.jsonbin.io/v3/b",E="$2a$10$0PieG5Wm.V.6svtN4PbaTuVxU4LY0nL2Vaz4N3g2aYlb0cL1NG4Qa";async function Xe(s){const t=await(await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":E,"X-Bin-Private":"false"},body:JSON.stringify(s)})).json();if(!t||!t.metadata||!t.metadata.id)throw new Error("無法取得 jsonbin id");return t.metadata.id}async function Ze(s){const t=await(await fetch(`https://api.jsonbin.io/v3/b/${s}/latest`,{})).json();if(!t||!t.record)throw new Error("找不到對應的教學方案");return t.record}async function et(s){const e={type:"quiz",quiz:s.quiz,topic:s.topic,apiKey:s.apiKey,metadata:s.metadata,createdAt:new Date().toISOString(),supportsDiagnostic:!!s.apiKey},n=await(await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":E,"X-Bin-Private":"false"},body:JSON.stringify(e)})).json();if(!n||!n.metadata||!n.metadata.id)throw new Error("無法儲存測驗內容");return n.metadata.id}async function tt(s){const t=await(await fetch(`https://api.jsonbin.io/v3/b/${s}/latest`,{})).json();if(!t||!t.record)throw new Error("找不到對應的測驗內容");const n=t.record;if(n.type!=="quiz")throw new Error("此連結不是測驗專用分享");return{quiz:n.quiz,topic:n.topic,apiKey:n.apiKey,supportsDiagnostic:n.supportsDiagnostic||!1,metadata:n.metadata}}async function nt(s){const e={type:"writing",writingPractice:s.writingPractice,topic:s.topic,metadata:s.metadata,createdAt:new Date().toISOString()},n=await(await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":E,"X-Bin-Private":"false"},body:JSON.stringify(e)})).json();if(!n||!n.metadata||!n.metadata.id)throw new Error("無法儲存寫作練習內容");return n.metadata.id}async function rt(s){const t=await(await fetch(`https://api.jsonbin.io/v3/b/${s}/latest`,{})).json();if(!t||!t.record)throw new Error("找不到對應的寫作練習內容");const n=t.record;if(n.type!=="writing")throw new Error("此連結不是寫作練習專用分享");return{writingPractice:n.writingPractice,topic:n.topic,metadata:n.metadata}}async function st(s){const e={type:"student-results",...s,createdAt:new Date().toISOString()},n=await(await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":E,"X-Bin-Private":"false"},body:JSON.stringify(e)})).json();if(!n||!n.metadata||!n.metadata.id)throw new Error("無法儲存學生作答結果");return n.metadata.id}async function se(s){const t=await(await fetch(`https://api.jsonbin.io/v3/b/${s}/latest`,{})).json();if(!t||!t.record)throw new Error("找不到對應的學生作答結果");const n=t.record;if(n.type!=="student-results")throw new Error("此連結不是學生作答結果專用分享");return{studentName:n.studentName,topic:n.topic,difficulty:n.difficulty,responses:n.responses,overallScore:n.overallScore,completedAt:n.completedAt,quizBinId:n.quizBinId,quizContent:n.quizContent,metadata:n.metadata,diagnosticReport:n.diagnosticReport}}async function it(s,e){const r={type:"student-results",...{...await se(s),diagnosticReport:{...e,generatedAt:new Date().toISOString(),resultsBinId:s},updatedAt:new Date().toISOString()}},a=await(await fetch(`https://api.jsonbin.io/v3/b/${s}`,{method:"PUT",headers:{"Content-Type":"application/json","X-Master-Key":E},body:JSON.stringify(r)})).json();if(!a||!a.metadata)throw new Error("無法更新學生作答結果")}async function at(s){const e={type:"conversation-practice",practice:s.practice,metadata:s.metadata,createdAt:new Date().toISOString()},n=await(await fetch(P,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":E,"X-Bin-Private":"false"},body:JSON.stringify(e)})).json();if(!n||!n.metadata||!n.metadata.id)throw new Error("無法儲存英文對話練習內容");return n.metadata.id}async function ot(s){const t=await(await fetch(`https://api.jsonbin.io/v3/b/${s}/latest`,{})).json();if(!t||!t.record)throw new Error("找不到對應的分享內容");return t.record}class ie{async generateConversationPractice(e){const{callGemini:t}=await M(async()=>{const{callGemini:a}=await import("./gemini-service-DqzV0kEP.js").then(o=>o.p);return{callGemini:a}},[]),n=this.buildConversationPrompt(e),r=await t(n);return{id:`conv_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,...r}}buildConversationPrompt(e){return`
...
`}async generateConversationFeedback(e,t,n){const{callGemini:r}=await M(async()=>{const{callGemini:a}=await import("./gemini-service-DqzV0kEP.js").then(o=>o.p);return{callGemini:a}},[]),i=`
...
Please respond in JSON format.`);const o={model:n,messages:[{role:"user",content:r}],stream:e.options?.stream??t.settings.stream??!1,max_tokens:e.options?.maxTokens??t.settings.max_tokens,temperature:e.options?.temperature??t.settings.temperature,top_p:t.settings.top_p,frequency_penalty:t.settings.frequency_penalty,presence_penalty:t.settings.presence_penalty};return t.settings.provider&&(o.provider=t.settings.provider),Object.keys(o).forEach(c=>{o[c]===void 0&&delete o[c]}),o}async executeApiCall(e){const t=await fetch(`${this.baseUrl}/chat/completions`,{method:"POST",headers:{Authorization:`Bearer ${this.config.apiKey}`,"Content-Type":"application/json","HTTP-Referer":window.location.origin,"X-Title":"AI Learning Page Generator"},body:JSON.stringify(e)});if(!t.ok){const n=await t.json().catch(()=>({}));throw new Error(n.error?.message||`HTTP ${t.status}: ${t.statusText}`)}return await t.json()}parseApiResponse(e){if(!e.choices||e.choices.length===0)throw new Error("OpenRouter 回應格式錯誤：缺少 choices");const t=e.choices[0];if(!t.message||!t.message.content)throw new Error("OpenRouter 回應格式錯誤：缺少訊息內容");const n=t.message.content.trim();console.log("OpenRouter 回應內容長度:",n.length),console.log("OpenRouter 回應內容前100字:",n.substring(0,100)),console.log("OpenRouter 回應內容後100字:",n.substring(Math.max(0,n.length-100)));const r=n.replace(/```json\n/g,"").replace(/\n```/g,"").replace(/```\n/g,"").replace(/```/g,"").trim();if(console.log("OpenRouter 清理後內容前100字:",r.substring(0,100)),r.startsWith("{")||r.startsWith("["))try{const i=JSON.parse(r);return console.log("OpenRouter JSON 解析成功:",typeof i,Object.keys(i||{})),i}catch(i){return console.error("OpenRouter 回應 JSON 解析失敗:",String(i)),console.log("JSON 解析失敗的內容:",r),r}return console.log("OpenRouter 回應不是 JSON 格式，返回清理後文字"),r}extractUsageInfo(e,...t){const n=t[0];if(n&&n.usage)return{promptTokens:n.usage.prompt_tokens,completionTokens:n.usage.completion_tokens,totalTokens:n.usage.total_tokens}}formatResponse(e,t,...n){try{const r=n[0];return{success:!0,data:e,provider:this.config.name,model:t,usage:r?.usage?{promptTokens:r.usage.prompt_tokens,completionTokens:r.usage.completion_tokens,totalTokens:r.usage.total_tokens}:void 0}}catch(r){return this.handleError(r,"格式化回應數據")}}getEffectiveModel(e){const t=this.config;return e.options?.model||t.model}handleError(e,t){let n="無法產生內容。";if(e instanceof Error&&(n+=` 詳細資料： ${e.message}`),e&&typeof e=="object"&&"message"in e){const r=e;r.message.includes("Unauthorized")||r.message.includes("401")?n="OpenRouter API 金鑰無效。請檢查您的設定。":r.message.includes("rate limit")||r.message.includes("429")?n="已超出 API 速率限制。請稍後再試。":r.message.includes("quota")||r.message.includes("insufficient")?n="已超出 API 配額或餘額不足。請檢查您的 OpenRouter 帳戶。":r.message.includes("model")||r.message.includes("not found")?n="所選模型不可用。請嘗試其他模型。":(r.message.includes("timeout")||r.message.includes("network"))&&(n="網路連接超時。請檢查網路連接後重試。")}return{success:!1,error:n,provider:this.config.name,model:this.getDefaultModel()}}async getAvailableModels(){try{const e=await fetch(`${this.baseUrl}/models`,{headers:{Authorization:`Bearer ${this.config.apiKey}`,"Content-Type":"application/json"}});if(!e.ok)throw new Error(`HTTP ${e.status}: ${e.statusText}`);return(await e.json()).data||[]}catch(e){return console.error("獲取 OpenRouter 模型清單失敗:",e),[]}}}class y{constructor(e){this.providers=new Map,this.usageStats=new Map,this.config=e,this.initializeProviders(),this.loadUsageStats()}static getInstance(e){return y.instance||(e||(e={providers:[],fallbackEnabled:!0,timeout:3e4,retryAttempts:3}),y.instance=new y(e)),y.instance}static reloadWithConfig(e){return y.instance=new y(e),y.instance}initializeProviders(){this.config.providers.forEach(e=>{try{const t=this.createProvider(e);this.providers.set(e.id,t)}catch(t){console.error(`初始化 Provider ${e.id} 失敗:`,t)}})}createProvider(e){switch(e.type){case w.GEMINI:return new ae(e);case w.OPENROUTER:return new oe(e)}}async addProvider(e){try{const t=this.createProvider(e),n=await this.testProvider(e.id,t);if(n.status===b.ERROR)throw new Error(`Provider 測試失敗: ${n.error}`);this.providers.set(e.id,t),this.config.providers.push(e),this.saveConfig(),console.log(`Provider ${e.id} 已成功添加`)}catch(t){throw console.error(`添加 Provider ${e.id} 失敗:`,t),t}}removeProvider(e){this.providers.delete(e),this.config.providers=this.config.providers.filter(t=>t.id!==e),this.usageStats.delete(e),this.saveConfig(),console.log(`Provider ${e} 已移除`)}async updateProvider(e){try{const t=this.createProvider(e),n=await this.testProvider(e.id,t);if(n.status===b.ERROR)throw new Error(`Provider 測試失敗: ${n.error}`);this.providers.set(e.id,t);const r=this.config.providers.findIndex(i=>i.id===e.id);r>=0&&(this.config.providers[r]=e),this.saveConfig(),console.log(`Provider ${e.id} 已更新`)}catch(t){throw console.error(`更新 Provider ${e.id} 失敗:`,t),t}}async testProvider(e,t){const n=Date.now(),r=t||this.providers.get(e);if(!r)return{providerId:e,status:b.ERROR,error:"Provider 不存在",testedAt:new Date().toISOString()};try{const i={prompt:'測試連接：請回應 "OK"',options:{maxTokens:500,responseFormat:"text"}},a=await r.generateContent(i),o=Date.now()-n;return{providerId:e,status:a.success?b.ACTIVE:b.ERROR,responseTime:o,error:a.error,testedAt:new Date().toISOString()}}catch(i){return{providerId:e,status:b.ERROR,error:i instanceof Error?i.message:"未知錯誤",testedAt:new Date().toISOString()}}}async testAllProviders(){const e=[];for(const[t,n]of this.providers){const r=await this.testProvider(t,n);e.push(r)}return e}async generateContent(e,t=S.DEFAULT){const n=await this.selectProvider(t);if(!n)throw new G({type:v.UNKNOWN_ERROR,message:"沒有可用的 Provider",provider:"none",retryable:!1});const r=Date.now();try{const i=await n.provider.generateContent(e),a=Date.now()-r;if(!i.success)throw new G({type:this.mapErrorType(i.error||""),message:i.error||"未知錯誤",provider:n.id,retryable:!0});return this.updateUsageStats(n.id,!0,a,i.usage?.totalTokens||0),{content:i.data,usage:i.usage,metadata:{model:i.model,provider:i.provider,responseTime:a,finishReason:"stop"}}}catch(i){if(this.updateUsageStats(n.id,!1,Date.now()-r,0),this.config.fallbackEnabled&&t!==S.FALLBACK)return console.warn(`Provider ${n.id} 失敗，嘗試 fallback...`),this.generateContent(e,S.FALLBACK);throw i}}async selectProvider(e){const t=Array.from(this.providers.entries()).filter(([n,r])=>r.isEnabled()).map(([n,r])=>({id:n,provider:r}));if(console.log("ProviderManager: 可用的 Provider:",t.map(n=>({id:n.id,type:n.provider.config.type}))),t.length===0)return console.log("ProviderManager: 沒有可用的 Provider"),null;switch(e){case S.DEFAULT:{const n=this.config.defaultProviderId;if(console.log("ProviderManager: 預設 Provider ID:",n),n&&this.providers.has(n)){const r={id:n,provider:this.providers.get(n)};return console.log("ProviderManager: 選擇預設 Provider:",{id:r.id,type:r.provider.config.type}),r}return console.log("ProviderManager: 預設 Provider 不可用，使用第一個可用的 Provider:",t[0].id),t[0]}case S.FASTEST:return this.selectFastestProvider(t);case S.FALLBACK:return this.selectFallbackProvider(t);case S.LOAD_BALANCE:return this.selectLoadBalanceProvider(t);default:return t[0]}}selectFastestProvider(e){let t=e[0],n=this.getAverageResponseTime(t.id);for(const r of e.slice(1)){const i=this.getAverageResponseTime(r.id);i<n&&(t=r,n=i)}return t}selectFallbackProvider(e){for(const t of this.config.providers){const n=e.find(r=>r.id===t.id);if(n)return n}return e[0]}selectLoadBalanceProvider(e){const t=Date.now(),n=Math.floor(t/1e3)%e.length;return e[n]}getAverageResponseTime(e){return this.usageStats.get(e)?.averageResponseTime||1/0}updateUsageStats(e,t,n,r){const i=this.usageStats.get(e)||{providerId:e,totalRequests:0,successfulRequests:0,failedRequests:0,averageResponseTime:0,totalTokensUsed:0,lastUsed:new Date().toISOString()};i.totalRequests++,t?i.successfulRequests++:i.failedRequests++;const a=i.averageResponseTime*(i.totalRequests-1)+n;i.averageResponseTime=a/i.totalRequests,i.totalTokensUsed+=r,i.lastUsed=new Date().toISOString(),this.usageStats.set(e,i),this.saveUsageStats()}mapErrorType(e){const t=e.toLowerCase();return t.includes("api key")||t.includes("invalid")?v.API_KEY_INVALID:t.includes("quota")||t.includes("exhausted")?v.QUOTA_EXCEEDED:t.includes("rate limit")?v.RATE_LIMIT_EXCEEDED:t.includes("model")||t.includes("not found")?v.MODEL_NOT_AVAILABLE:t.includes("network")||t.includes("connection")?v.NETWORK_ERROR:t.includes("json")||t.includes("parsing")?v.PARSING_ERROR:v.UNKNOWN_ERROR}getProviders(){return[...this.config.providers]}getProvider(e){return this.config.providers.find(t=>t.id===e)}getUsageStats(){return Array.from(this.usageStats.values())}setDefaultProvider(e){if(!this.providers.has(e))throw new Error(`Provider ${e} 不存在`);this.config.defaultProviderId=e,this.saveConfig()}saveConfig(){try{localStorage.setItem("provider_manager_config",JSON.stringify(this.config))}catch(e){console.error("保存 Provider 配置失敗:",e)}}loadUsageStats(){try{const e=localStorage.getItem("provider_usage_stats");if(e){const t=JSON.parse(e);this.usageStats=new Map(Object.entries(t))}}catch(e){console.error("載入使用統計失敗:",e)}}saveUsageStats(){try{const e=Object.fromEntries(this.usageStats);localStorage.setItem("provider_usage_stats",JSON.stringify(e))}catch(e){console.error("保存使用統計失敗:",e)}}clearUsageStats(){this.usageStats.clear(),localStorage.removeItem("provider_usage_stats")}exportConfig(){const e={version:"1.0.0",exportedAt:new Date().toISOString(),configs:this.config.providers.map(t=>({...t,apiKey:""})),metadata:{appVersion:"1.0.0",description:"AI Provider 配置匯出"}};return JSON.stringify(e,null,2)}async importConfig(e){try{const t=JSON.parse(e);if(!t.configs||!Array.isArray(t.configs))throw new Error("無效的配置格式");for(const n of t.configs){if(!n.apiKey){console.warn(`跳過 ${n.name}：缺少 API Key`);continue}await this.addProvider({...n,id:`${n.type}_${Date.now()}`,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()})}}catch(t){throw console.error("匯入配置失敗:",t),t}}}const ce={BASE_URL:"/ai-page-gen/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_APP_NAME:"AI English Teaching Generator",VITE_ENABLE_BRANCH_RECOMMENDATION:"false",VITE_ENABLE_MATH_RENDER:"false",VITE_ENABLE_SPEECH:"true",VITE_JSONBIN_API_KEY:"$2a$10$0PieG5Wm.V.6svtN4PbaTuVxU4LY0nL2Vaz4N3g2aYlb0cL1NG4Qa"};var le={};const J="https://api.jsonbin.io/v3",q=import.meta&&ce&&"$2a$10$0PieG5Wm.V.6svtN4PbaTuVxU4LY0nL2Vaz4N3g2aYlb0cL1NG4Qa"||le.VITE_JSONBIN_API_KEY||"";class ${constructor(){this.manager=null,this.initializeManager()}static getInstance(){return $.instance||($.instance=new $),$.instance}async initializeManager(){try{const e=this.loadManagerConfig();this.manager=y.reloadWithConfig(e)}catch(e){console.error("初始化 Provider Manager 失敗:",e);const t={providers:[],fallbackEnabled:!0,timeout:3e4,retryAttempts:3};this.manager=y.reloadWithConfig(t)}}loadManagerConfig(){const e=localStorage.getItem("provider_manager_config");if(e)try{return JSON.parse(e)}catch(r){console.error("解析 Provider 配置失敗:",r)}const t=localStorage.getItem("gemini_api_key"),n=[];if(t){const r={id:"gemini_migrated",name:"Gemini (已遷移)",type:w.GEMINI,enabled:!0,apiKey:t,model:"gemini-2.5-flash",settings:{responseMimeType:"application/json",temperature:.7,maxOutputTokens:8192},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};n.push(r)}return{providers:n,defaultProviderId:n.length>0?n[0].id:void 0,fallbackEnabled:!0,timeout:3e4,retryAttempts:3}}async getManager(){return this.manager||await this.initializeManager(),this.manager}async getProviders(){return(await this.getManager()).getProviders()}async addProvider(e){await(await this.getManager()).addProvider(e),await this.initializeManager()}async updateProvider(e){await(await this.getManager()).updateProvider(e),await this.initializeManager()}async removeProvider(e){(await this.getManager()).removeProvider(e),await this.initializeManager()}async testProvider(e){return await(await this.getManager()).testProvider(e)}async testAllProviders(){return await(await this.getManager()).testAllProviders()}async setDefaultProvider(e){(await this.getManager()).setDefaultProvider(e)}async getUsageStats(){return(await this.getManager()).getUsageStats()}async generateContent(e,t){return await(await this.getManager()).generateContent(e,t)}async exportProviderConfig(){return(await this.getManager()).exportConfig()}async importProviderConfig(e){await(await this.getManager()).importConfig(e)}async shareProviderConfig(e,t,n,r=!1){try{const i={id:`share_${Date.now()}`,name:t,description:n,configs:e.map(c=>({...c,apiKey:"",id:"",createdAt:"",updatedAt:""})),isPublic:r,createdAt:new Date().toISOString(),tags:this.extractTagsFromConfigs(e)},a=await fetch(`${J}/b`,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":q},body:JSON.stringify(i)});if(!a.ok)throw new Error(`分享失敗: ${a.statusText}`);return(await a.json()).metadata.id}catch(i){throw console.error("分享 Provider 配置失敗:",i),i}}async loadSharedProviderConfig(e){try{const t=await fetch(`${J}/b/${e}/latest`,{headers:{"X-Master-Key":q}});if(!t.ok)throw new Error(`載入失敗: ${t.statusText}`);return(await t.json()).record}catch(t){throw console.error("載入分享的 Provider 配置失敗:",t),t}}async createProvidersFromShared(e,t){const n=[];for(const r of e.configs){const i=t[r.type];if(!i){console.warn(`跳過 ${r.name}：缺少 ${r.type} API Key`);continue}const a={...r,id:`${r.type}_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,apiKey:i,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),name:`${r.name} (已匯入)`};await this.addProvider(a),n.push(a)}return n}extractTagsFromConfigs(e){const t=new Set;return e.forEach(n=>{if(t.add(n.type),n.type===w.GEMINI)t.add("google"),t.add("multimodal");else if(n.type===w.OPENROUTER){t.add("unified-api");const r=n.model;r.includes("openai")&&t.add("openai"),r.includes("anthropic")&&t.add("anthropic"),r.includes("google")&&t.add("google"),r.includes("meta")&&t.add("meta")}}),Array.from(t)}async clearAllData(){localStorage.removeItem("provider_manager_config"),localStorage.removeItem("provider_usage_stats"),this.manager=null,await this.initializeManager()}async hasConfiguredProviders(){const e=await this.getProviders();return e.length>0&&e.some(t=>t.enabled&&t.apiKey)}async getFirstAvailableProvider(){return(await this.getProviders()).find(t=>t.enabled&&t.apiKey)||null}async migrateLegacyApiKey(){const e=localStorage.getItem("gemini_api_key");if(!e)return;if(!(await this.getProviders()).some(r=>r.type===w.GEMINI)){const r={id:"gemini_migrated",name:"Gemini (已遷移)",type:w.GEMINI,enabled:!0,apiKey:e,model:"gemini-2.5-flash",settings:{responseMimeType:"application/json",temperature:.7,maxOutputTokens:8192},createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};try{await this.addProvider(r),await this.setDefaultProvider(r.id),console.log("已成功遷移 Gemini API Key 到新的 Provider 系統")}catch(i){console.error("遷移 Gemini API Key 失敗:",i)}}}async getLegacyApiKey(){return(await this.getFirstAvailableProvider())?.apiKey||null}}const O=$.getInstance(),h=async(s,e="provider-system-call")=>{try{!await O.hasConfiguredProviders()&&e!=="provider-system-call"&&await O.migrateLegacyApiKey();const n={prompt:s,options:{responseFormat:"json",maxTokens:8192,temperature:.7}};console.log("Provider 系統: 生成內容中...");const r=await O.generateContent(n,S.DEFAULT);console.log("Provider 系統回應:",{provider:r.metadata?.provider,model:r.metadata?.model});let i=r.content;if(i&&typeof i=="object"&&i.choices)try{i=i.choices[0].message.content,console.log("✓ 檢測到 OpenRouter 格式，提取內容")}catch(a){console.warn("⚠ OpenRouter 格式提取失敗:",a)}if(typeof i=="string")try{let a=i.replace(/```json\n/g,"").replace(/\n```/g,"").replace(/```\n/g,"").replace(/```/g,"").trim();if(!a.startsWith("{")&&!a.startsWith("[")){const o=Math.min(a.indexOf("{")!==-1?a.indexOf("{"):1/0,a.indexOf("[")!==-1?a.indexOf("["):1/0);if(o!==1/0){const l=a.charAt(o)==="{"?a.lastIndexOf("}"):a.lastIndexOf("]");l>o&&(a=a.substring(o,l+1))}}i=JSON.parse(a),console.log("✓ JSON 解析成功 (Provider 系統)")}catch(a){console.warn("⚠ JSON 解析失敗，返回原始內容:",a),i=r.content}return i}catch(t){if(console.error("Provider 系統錯誤:",t),e&&e.startsWith("AIza")){console.log("回退到原始 Gemini 服務");const{callGemini:n}=await M(async()=>{const{callGemini:r}=await import("./gemini-service-DqzV0kEP.js").then(i=>i.q);return{callGemini:r}},[]);return await n(s,e)}else throw t}},A=async(s,e)=>{const t=`
  ...
  `;return await h(t,e)},ue=async(s,e,t,n,r)=>{const i=r+1,a=`
    Based on the topic "${s}" and this specific learning objective (Objective ${i}): 
    ${JSON.stringify(t)}
    ...
    - topic: The specific sub-topic title. MUST start with "Unit ${i}.[Sub-unit]" (e.g., "Unit ${i}.1: [Name]", "Unit ${i}.2: [Name]").
  ...
  `;return await h(a,e)},de=async(s,e,t)=>{const n=/english|英語|英文|grammar|vocabulary|pronunciation|speaking|listening|reading|writing/i.test(s);console.log(`Starting chunked content breakdown generation for topic: ${s}`);try{return(await Promise.all(t.map((i,a)=>ue(s,e,i,n,a).catch(o=>(console.warn(`Failed to generate breakdown for objective: ${i.objective}`,o),[]))))).flat()}catch(r){throw console.error("Error generating chunked content breakdown:",r),r}},pe=async(s,e,t)=>{const n=`
    Based on the topic "${s}" and this specific learning objective:
    ${JSON.stringify(t)}
    ...
    - Do NOT generate a generic confusing point for the overall topic "${s}".
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(n,e)},ge=async(s,e,t)=>{console.log(`Starting chunked confusing points generation for topic: ${s}. Objectives count: ${t.length}`);try{const r=(await Promise.all(t.map(i=>pe(s,e,i).catch(a=>(console.warn(`Failed to generate confusing point for objective: ${i.objective}`,a),[]))))).flat();return console.log(`Generated ${r.length} confusing points. Titles: ${r.map(i=>i.point).join(", ")}`),r}catch(n){throw console.error("Error generating chunked confusing points:",n),n}},he=async(s,e,t)=>{const n=`
  ...
  `;return await h(a,t)},me=async(s,e,t,n=!1)=>{console.log(`Starting chunked quiz generation for topic: ${s}`);try{const[r,i,a]=await Promise.all([I(s,"easy",e,t,n),I(s,"normal",e,t,n),I(s,"hard",e,t,n)]);return{easy:r,normal:i,hard:a}}catch(r){throw console.error("Error generating chunked quiz:",r),r}},fe=async(s,e,t)=>{const n=`
    Based on the following learning objectives: ${JSON.stringify(t)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(n,e)},lt=async(s,e,t)=>{const n=`
  ...
  `;return await t(n,e)},ut=async(s,e,t)=>{const n=`
  ...
  `;return await t(n,e)},dt=async(s,e,t)=>{const n=`
    ...
    Use Traditional Chinese. Do NOT include any explanation or extra text. Only output the JSON object.
  `;return await t(n,e)},ye=async(s,e,t)=>{const n=`
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(n,t)},we=async(s,e,t,n,r,i)=>{const a=i+1,o=`
    Based on the topic "${s}" and this specific learning objective (Objective ${a}):
    ${JSON.stringify(n)}
    ...
    [
      {
        "topic": "Unit ${a}.1: 適合${e.name}的子主題A",
    ...
    [
      { "topic": "Unit ${a}.1: 適合${e.name}的子主題A", "details": "子主題A針對${e.name}程度的簡要說明...", "teachingExample": "子主題A適合此程度的教學示例..." }
    ]
    `}

    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(o,t)},ve=async(s,e,t,n)=>{const r=/english|英語|英文|grammar|vocabulary|pronunciation|speaking|listening|reading|writing/i.test(s);console.log(`Starting chunked content breakdown generation for topic: ${s}, level: ${e.name}`);try{return(await Promise.all(n.map((a,o)=>we(s,e,t,a,r,o).catch(c=>(console.warn(`Failed to generate breakdown for objective: ${a.objective}`,c),[]))))).flat()}catch(i){throw console.error("Error generating chunked content breakdown:",i),i}},Se=async(s,e,t,n)=>{const r=`
    Based on the topic "${s}" and this specific learning objective:
    ${JSON.stringify(n)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(r,t)},be=async(s,e,t,n)=>{console.log(`Starting chunked confusing points generation for topic: ${s}, level: ${e.name}`);try{return(await Promise.all(n.map(i=>Se(s,e,t,i).catch(a=>(console.warn(`Failed to generate confusing point for objective: ${i.objective}`,a),[]))))).flat()}catch(r){throw console.error("Error generating chunked confusing points:",r),r}},$e=async(s,e,t,n)=>{const r=`
    Based on the following learning objectives: ${JSON.stringify(n)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(r,t)},Ae=async(s,e,t,n,r=!1)=>{const i=`
  ...
  `;return await h(i,t)},Ee=async(s,e,t,n)=>{const r=`
    Based on the following learning objectives: ${JSON.stringify(n)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(r,t)},Ce=async(s,e,t,n)=>{const r=`
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(r,n)},Oe=async(s,e,t,n,r,i,a)=>{const o=a+1,c=`
    Based on the topic "${s}" and this specific learning objective (Objective ${o}):
    ${JSON.stringify(r)}
    ...
    [
      {
        "topic": "Unit ${o}.1: 適合${t.name}的子主題A",
    ...
    Standard output format:
    [
      { "topic": "Unit ${o}.1: 適合${t.name}的子主題A", "details": "子主題A針對${t.wordCount}詞彙量的簡要說明...", "teachingExample": "子主題A使用${t.name}程度詞彙的教學示例..." }
    ]
    `}

    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(c,n)},Pe=async(s,e,t,n,r)=>{const i=/english|英語|英文|grammar|vocabulary|pronunciation|speaking|listening|reading|writing/i.test(s);console.log(`Starting chunked content breakdown generation for topic: ${s}, level: ${e.name}, vocab: ${t.name}`);try{return(await Promise.all(r.map((o,c)=>Oe(s,e,t,n,o,i,c).catch(l=>(console.warn(`Failed to generate breakdown for objective: ${o.objective}`,l),[]))))).flat()}catch(a){throw console.error("Error generating chunked content breakdown:",a),a}},Te=async(s,e,t,n,r)=>{const i=`
    Based on the topic "${s}" and this specific learning objective:
    ${JSON.stringify(r)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(i,n)},xe=async(s,e,t,n,r)=>{console.log(`Starting chunked confusing points generation for topic: ${s}, level: ${e.name}, vocab: ${t.name}`);try{return(await Promise.all(r.map(a=>Te(s,e,t,n,a).catch(o=>(console.warn(`Failed to generate confusing point for objective: ${a.objective}`,o),[]))))).flat()}catch(i){throw console.error("Error generating chunked confusing points:",i),i}},Ne=async(s,e,t,n,r)=>{const i=`
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(i,n)},ke=async(s,e,t,n,r,i=!1)=>{const a=i?"":`
        "sentenceScramble": [
    ...
    For each quiz type (trueFalse, multipleChoice, fillInTheBlanks${i?"":", sentenceScramble"}), generate at least 5 questions per difficulty level (easy, normal, hard), but more is better if appropriate.
  ...
  `;return await h(o,n)},Ie=async(s,e,t,n,r)=>{const i=`
    Based on the following learning objectives: ${JSON.stringify(r)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON array.
  `;return await h(i,n)},Re=async(s,e,t,n,r,i)=>{const o=(g=>{const p={...g};for(const f of["easy","normal","hard"]){p[f]||(p[f]={});const m=p[f];m.trueFalse=Math.min(Math.max(m.trueFalse||0,0),10),m.multipleChoice=Math.min(Math.max(m.multipleChoice||0,0),10),m.fillInTheBlanks=Math.min(Math.max(m.fillInTheBlanks||0,0),10),m.sentenceScramble=Math.min(Math.max(m.sentenceScramble||0,0),10),m.memoryCardGame=Math.min(Math.max(m.memoryCardGame||0,0),2)}return p})(n),c=async g=>{const p=o[g];let f="";r&&(f=`適合「${r.name}」程度學習者 (${r.description}) 的`);let m="";i&&(m=`
      CRITICAL VOCABULARY CONSTRAINTS for English content:
      ...
      - All text must be in the primary language of the topic
      - Do NOT include any explanation or extra text, only output the JSON object
    `;return await h(C,e)},[l,u,d]=await Promise.all([c("easy"),c("normal"),c("hard")]);return{easy:l,normal:u,hard:d}},pt=async(s,e,t,n,r)=>await Re(s,"",e,t,n,r),gt=async(s,e,t,n,r)=>{const i=/[a-zA-Z]/.test(s),a=`
  ...
  `;return await h(a,n)},D=async(s,e,t,n,r)=>{const i=`
  ...
  `,a=`
    ...
    Do NOT include explanation, only output the JSON array.
  `,[o,c]=await Promise.all([h(i,e),h(a,e)]);return{sentencePractice:o,writingPractice:c,instructions:"這裡提供了造句和寫作練習，幫助學習者提升語言表達能力。造句練習著重於詞彙運用，寫作練習則訓練文章結構和論述能力。完成後可以使用AI批改功能獲得即時回饋。"}},je=s=>{const e=[];return s.forEach((t,n)=>{if(!t.pairs||!Array.isArray(t.pairs)){e.push(`遊戲 ${n+1}: 缺少 pairs 陣列`);return}const r=new Set,i=new Set;t.pairs.forEach((a,o)=>{if(!a.left||!a.right){e.push(`遊戲 ${n+1}, 配對 ${o+1}: 缺少 left 或 right 內容`);return}r.has(a.left)&&e.push(`遊戲 ${n+1}: 左側內容重複 - "${a.left}"`),i.has(a.right)&&e.push(`遊戲 ${n+1}: 右側內容重複 - "${a.right}"`),r.add(a.left),i.add(a.right)})}),{isValid:e.length===0,issues:e}},ht=async(s,e,t)=>{const n=`
    ...
    Do NOT include any explanation or extra text outside the JSON structure.
  `,r=await h(n,"provider-system-call");if(r.memoryCardGame&&Array.isArray(r.memoryCardGame)){const i=je(r.memoryCardGame);i.isValid||(console.warn("記憶卡遊戲驗證失敗:",i.issues),r._validationWarnings=i.issues)}return r},N=async(s,e,t,n)=>{const r=`
    Based on the topic "${s}" and learning objectives: ${JSON.stringify(t)}
    ...
    Do NOT include any explanation or extra text. Only output the JSON object.
  `;return await n(r,e)},mt=async(s,e,t)=>{console.log(`生成學習程度建議 (Provider 系統): ${s}`);const n=await A(s,e);return await N(s,e,n,t)},ft=s=>{const e=["english","grammar","vocabulary","pronunciation","speaking","writing","reading","listening","conversation","toefl","ielts","toeic","english literature","business english","academic english","phrasal verbs","idioms","prepositions","tenses","articles","adjectives","adverbs","nouns","verbs","英語","英文","文法","單字","發音","口說","寫作","閱讀","聽力","對話","會話","托福","雅思","多益","商業英文","學術英文","片語動詞","慣用語","介系詞","時態","冠詞","形容詞","副詞","名詞","動詞"],t=s.toLowerCase();return e.some(n=>t.includes(n))},_=s=>{const e=["math","algebra","geometry","calculus","statistics","probability","trigonometry","arithmetic","fraction","decimal","percentage","equation","formula","graph","function","matrix","vector","數學","代數","幾何","微積分","統計","機率","三角函數","算術","分數","小數","百分比","方程式","公式","圖表","函數","矩陣","向量","加法","減法","乘法","除法","因數","倍數","質數","合數","最大公因數","最小公倍數"],t=s.toLowerCase();return e.some(n=>t.includes(n))},yt=async(s,e,t,n={})=>{console.log(`開始生成學習計劃 (Provider 系統): ${s}`);const r=await A(s,e);return console.log("✓ 學習目標生成完成"),await B(s,r,e,t,n)},B=async(s,e,t,n,r={})=>{console.log(`開始從現有目標生成學習計劃 (Provider 系統): ${s}`);const i=r.isMath!==void 0?r.isMath:_(s),[a,o,c,l,u,d,g]=await Promise.all([de(s,t,e),ge(s,t,e),he(s,t,e),me(s,t,e,i),r.includeEnglishConversation!==!1?fe(s,t,e):Promise.resolve([]),N(s,t,e,n),r.includeWritingPractice!==!1?D(s,t,e):Promise.resolve(void 0)]);return console.log("✓ 所有內容生成完成 (Provider 系統)"),{learningObjectives:e,contentBreakdown:a,confusingPoints:o,classroomActivities:c,onlineInteractiveQuiz:l,englishConversation:u,learningLevels:d,writingPractice:g}},wt=async(s,e,t,n)=>{console.log(`開始生成學習計劃 (有程度設定, Provider 系統): ${s}, 程度: ${e?.name||"未指定"}`);const r=_(s),i=await ye(s,e,t);console.log("✓ 程度特定學習目標生成完成");const[a,o,c,l,u,d,g]=await Promise.all([ve(s,e,t,i),be(s,e,t,i),$e(s,e,t,i),Ae(s,e,t,i,r),Ee(s,e,t,i),N(s,t,i,n),D(s,t,i,e)]);return console.log("✓ 所有程度特定內容生成完成 (Provider 系統)"),{learningObjectives:i,contentBreakdown:a,confusingPoints:o,classroomActivities:c,onlineInteractiveQuiz:l,englishConversation:u,learningLevels:d,writingPractice:g}},vt=async(s,e,t,n,r)=>{console.log(`開始生成學習計劃 (有程度和詞彙設定, Provider 系統): ${s}, 程度: ${e?.name||"未指定"}, 詞彙: ${t?.name||"未指定"}`);const i=_(s),a=await Ce(s,e,t,n);console.log("✓ 程度和詞彙特定學習目標生成完成");const[o,c,l,u,d,g,p]=await Promise.all([Pe(s,e,t,n,a),xe(s,e,t,n,a),Ne(s,e,t,n,a),ke(s,e,t,n,a,i),Ie(s,e,t,n,a),N(s,n,a,r),D(s,n,a,e,t)]);return console.log("✓ 所有程度和詞彙特定內容生成完成 (Provider 系統)"),{learningObjectives:a,contentBreakdown:o,confusingPoints:c,classroomActivities:l,onlineInteractiveQuiz:u,englishConversation:d,learningLevels:g,writingPractice:p}},St=async()=>await O.hasConfiguredProviders(),bt=async s=>await O.addProvider(s),$t=async()=>(console.log("Provider 系統初始化中..."),!0),Y={preschool:"Preschool",elementary_low:"Elementary School (Grades 1-2)",elementary_mid:"Elementary School (Grades 3-4)",elementary_high:"Elementary School (Grades 5-6)",junior_7:"Junior High School (Grade 7)",junior_8:"Junior High School (Grade 8)",junior_9:"Junior High School (Grade 9)",high_school_review:"High School Review"},Q={physical:"Physical Classroom",online:"Online / Remote Learning"},H={none:"Standard / No specific prior issues",partial:"Partial Knowledge / Needs Review",special_needs:"Special Needs / Requires Extra Scaffolding"},Me={visual:"Visual Learning (Diagrams, Graphs)",cpa:"CPA (Concrete-Pictorial-Abstract)",concept_oriented:"Concept-Oriented (Understanding over Rote Memorization)",discovery:"Discovery Learning",gamification:"Gamification",contextual:"Contextual Learning (Real-world applications)"},De={clt:"Communicative Language Teaching (CLT)",tbl:"Task-Based Learning (TBL)",pbl:"Project-Based Learning (PBL)",tpr:"Total Physical Response (TPR)",phonics:"Phonics",grammar_translation:"Grammar-Translation",ppp:"PPP (Presentation, Practice, Production)",cooperative:"Cooperative Learning",gamification:"Gamification",flipped:"Flipped Classroom",scaffolding:"Scaffolding / Educational Drama",clil:"CLIL (Content and Language Integrated Learning)"},L=s=>{const{selectedMaterials:e,studentCount:t,classDuration:n,teachingContext:r,priorExperience:i,studentGrade:a,teachingMethod:o}=s;return`
...
- Duration: ${n} minutes
- Setting: ${Q[r]||r}
- Student Background: ${H[i]||i}
- Teaching Method: ${Me[o]||o}
`.trim()},V=s=>{const{selectedMaterials:e,studentCount:t,classDuration:n,teachingContext:r,priorExperience:i,studentGrade:a,teachingMethod:o}=s;return`
...
- Setting: ${Q[r]||r}
- Student Background: ${H[i]||i}
- Teaching Method: ${De[o]||o}
`.trim()},X=(s,e)=>{const t=[];for(let n=0;n<s.length;n+=e)t.push(s.slice(n,n+e));return t},At=async(s,e)=>{const t=L(s);if(s.selectedMaterials.length>5){console.log(`Detected large number of materials (${s.selectedMaterials.length}), using chunked generation for objectives.`);const i=X(s.selectedMaterials,5).map(async c=>{const l={...s,selectedMaterials:c},u=L(l);return await A(u,e)}),o=(await Promise.all(i)).flat();return{topic:t,learningObjectives:o}}console.log(`開始生成數學學習目標 (Provider 系統): ${t}`);const n=await A(t,e);return{topic:t,learningObjectives:n}},Et=async(s,e,t,n)=>(console.log(`開始生成數學學習內容 (Provider 系統): ${s}`),await B(s,e,t,n,{includeEnglishConversation:!1,includeWritingPractice:!1,isMath:!0})),Ct=async(s,e)=>{const t=V(s);if(s.selectedMaterials.length>5){console.log(`Detected large number of materials (${s.selectedMaterials.length}), using chunked generation for objectives.`);const i=X(s.selectedMaterials,5).map(async c=>{const l={...s,selectedMaterials:c},u=V(l);return await A(u,e)}),o=(await Promise.all(i)).flat();return{topic:t,learningObjectives:o}}console.log(`開始生成英語學習目標 (Provider 系統): ${t}`);const n=await A(t,e);return{topic:t,learningObjectives:n}},Ot=async(s,e,t,n)=>(console.log(`開始生成英語學習內容 (Provider 系統): ${s}`),await B(s,e,t,n,{includeEnglishConversation:!0,includeWritingPractice:!0}));var _e=(s=>(s.Easy="easy",s.Normal="normal",s.Hard="hard",s))(_e||{});const Pt={easy:{trueFalse:5,multipleChoice:5,fillInTheBlanks:5,sentenceScramble:5,memoryCardGame:1},normal:{trueFalse:5,multipleChoice:5,fillInTheBlanks:5,sentenceScramble:5,memoryCardGame:1},hard:{trueFalse:5,multipleChoice:5,fillInTheBlanks:5,sentenceScramble:5,memoryCardGame:1}},Tt={trueFalse:10,multipleChoice:10,fillInTheBlanks:10,sentenceScramble:10,memoryCardGame:2},k=async s=>{try{const e=await ee(s);let t=e;if(typeof t=="string"){let n=t.trim();const r=/^```(\w*)?\s*\n?(.*?)\n?\s*```$/s,i=n.match(r);if(i&&i[2]&&(n=i[2].trim()),!n.startsWith("{")&&!n.startsWith("[")&&(n.includes("{")||n.includes("["))){const a=n.indexOf("{"),o=n.indexOf("[");let c=-1,l=-1;a!==-1&&(o===-1||a<o)?(c=a,l=n.lastIndexOf("}")):o!==-1&&(c=o,l=n.lastIndexOf("]")),c!==-1&&l!==-1&&l>c&&(n=n.substring(c,l+1))}try{t=JSON.parse(n)}catch{throw console.error("AI 回傳原始內容 (JSON parse 失敗):",e),new Error("AI 模型傳回的資料格式無法解析 (可能不是有效的 JSON)。請嘗試修改您的主題或重試。")}}return t}catch(e){let t="無法產生診斷內容。";throw e instanceof Error&&(t+=` 詳細資料： ${e.message}`),new Error(t)}},Be=s=>{const e=new Map;return s.forEach(t=>{e.has(t.questionType)||e.set(t.questionType,{questionType:t.questionType,totalQuestions:0,correctCount:0,accuracy:0,averageTime:0,commonErrors:[],difficultyBreakdown:{easy:{total:0,correct:0,accuracy:0},normal:{total:0,correct:0,accuracy:0},hard:{total:0,correct:0,accuracy:0}}})}),s.forEach(t=>{const n=e.get(t.questionType);n.totalQuestions++,t.isCorrect&&n.correctCount++;const r=n.difficultyBreakdown[t.difficulty];r.total++,t.isCorrect&&r.correct++,r.accuracy=r.total>0?Math.round(r.correct/r.total*100):0}),e.forEach(t=>{t.accuracy=t.totalQuestions>0?Math.round(t.correctCount/t.totalQuestions*100):0;const r=s.filter(i=>i.questionType===t.questionType).filter(i=>i.responseTime).map(i=>i.responseTime);t.averageTime=r.length>0?Math.round(r.reduce((i,a)=>i+a,0)/r.length):void 0}),Array.from(e.values())},Ue=s=>{if(s.length===0)return 0;const e=s.filter(t=>t.isCorrect).length;return Math.round(e/s.length*100)},Fe=s=>s>=80?"advanced":s>=60?"intermediate":"beginner",Ge=async(s,e)=>{const t=e.filter(o=>!o.isCorrect),n=e.filter(o=>o.isCorrect),r=t.map(o=>`
    題型: ${o.questionType}
    難度: ${o.difficulty}
...
`),a=`
  ...
  `;try{return await k(a)}catch(o){return console.error("AI 學習分析生成失敗:",o),{strengths:[],weaknesses:[],learningStyle:"無法分析",cognitivePattern:"需要更多數據"}}},Je=async(s,e,t,n,r)=>{const i=`
  ...
  `;try{return(await k(i)).recommendations||[]}catch(a){return console.error("AI 個人化建議生成失敗:",a),[]}},qe=async(s,e,t,n,r,i,a)=>{const c=(a?.filter(u=>!u.isCorrect)||[]).map(u=>`
  ...
  `;try{const u=await k(l);return{studentId:i,overallScore:e,overallLevel:t,encouragementMessage:u.encouragementMessage||"你的學習表現很棒！",keyStrengths:u.keyStrengths||[],improvementAreas:u.improvementAreas||[],nextSteps:u.nextSteps||[],studyTips:u.studyTips||[],motivationalQuote:u.motivationalQuote||"持續努力，你會更進步！"}}catch(u){return console.error("AI 學生回饋生成失敗:",u),{studentId:i,overallScore:e,overallLevel:t,encouragementMessage:"你的學習表現很棒！繼續保持這個學習態度。",keyStrengths:["積極參與測驗","展現學習動機"],improvementAreas:["需要更多練習"],nextSteps:["重新檢視錯誤題目","加強基礎概念","定期練習"],studyTips:["制定規律的學習時間","多做類似練習題","請教老師或同學"],motivationalQuote:"每一次練習都讓你更接近目標！"}}},Le=async(s,e,t,n,r,i)=>{const o=(i?.filter(l=>!l.isCorrect)||[]).map(l=>`
  ...
  `;try{const l=await k(c);return{immediateInterventions:l.immediateInterventions||[],instructionalStrategies:l.instructionalStrategies||[],differentiation:l.differentiation||[],parentGuidance:l.parentGuidance||[]}}catch(l){return console.error("AI 教學建議生成失敗:",l),{immediateInterventions:[],instructionalStrategies:[],differentiation:[],parentGuidance:[]}}},xt=async s=>{try{const e=Be(s.responses),t=Ue(s.responses),n=Fe(t),r=await Ge(s.topic,s.responses),i=await Je(s.topic,t,n,r.strengths,r.weaknesses),a=await qe(s.topic,t,n,r.strengths,r.weaknesses,s.studentId,s.responses),o=await Le(s.topic,t,e,r.strengths,r.weaknesses,s.responses),c={studentId:s.studentId,assessmentDate:new Date().toISOString(),topic:s.topic,overallPerformance:{totalScore:t,level:n,timeSpent:s.endTime&&s.startTime?Math.round((new Date(s.endTime).getTime()-new Date(s.startTime).getTime())/6e4):0},performanceByType:e,learningAnalysis:r,teachingRecommendations:o,personalizedRecommendations:i,progressTracking:{keyMetrics:["正確率提升","回答速度","概念理解深度"],checkpoints:["一週後複習","兩週後小測驗","一個月後綜合評估"],reassessmentSuggestion:"建議在完成建議的學習活動後，於 2-3 週內進行重新評估"}};return{session:s,studentFeedback:a,teacherReport:c,rawData:{responses:s.responses,statistics:e},generatedAt:new Date().toISOString()}}catch(e){throw console.error("生成學習診斷失敗:",e),new Error("無法生成學習診斷報告，請稍後重試")}},Nt=(s,e)=>({sessionId:`session_${Date.now()}_${Math.random().toString(36).slice(2,11)}`,studentId:e,topic:s,startTime:new Date().toISOString(),responses:[],isCompleted:!1,metadata:{userAgent:navigator.userAgent,deviceType:/Mobi|Android/i.test(navigator.userAgent)?"mobile":"desktop"}}),kt=s=>({...s,endTime:new Date().toISOString(),isCompleted:!0});class Ve{constructor(){this.dbName="AILearningPageGenerator",this.version=1,this.storeName="lessonPlans",this.db=null}async init(){return new Promise((e,t)=>{const n=indexedDB.open(this.dbName,this.version);n.onerror=()=>{t(new Error("Failed to open IndexedDB"))},n.onsuccess=r=>{this.db=r.target.result,e()},n.onupgradeneeded=r=>{const i=r.target.result;if(!i.objectStoreNames.contains(this.storeName)){const a=i.createObjectStore(this.storeName,{keyPath:"id"});a.createIndex("topic","topic",{unique:!1}),a.createIndex("createdAt","createdAt",{unique:!1}),a.createIndex("lastAccessedAt","lastAccessedAt",{unique:!1})}}})}async ensureDB(){if(this.db||await this.init(),!this.db)throw new Error("Database not initialized");return this.db}async saveLessonPlan(e){const t=await this.ensureDB();return new Promise((n,r)=>{const o=t.transaction([this.storeName],"readwrite").objectStore(this.storeName).put(e);o.onsuccess=()=>n(),o.onerror=()=>r(new Error("Failed to save lesson plan"))})}async getAllLessonPlans(){const e=await this.ensureDB();return new Promise((t,n)=>{const o=e.transaction([this.storeName],"readonly").objectStore(this.storeName).index("lastAccessedAt").openCursor(null,"prev"),c=[];o.onsuccess=l=>{const u=l.target.result;u?(c.push(u.value),u.continue()):t(c)},o.onerror=()=>n(new Error("Failed to get lesson plans"))})}async getLessonPlan(e){const t=await this.ensureDB();return new Promise((n,r)=>{const o=t.transaction([this.storeName],"readonly").objectStore(this.storeName).get(e);o.onsuccess=()=>{const c=o.result;n(c||null)},o.onerror=()=>r(new Error("Failed to get lesson plan"))})}async updateLastAccessed(e){const t=await this.getLessonPlan(e);t&&(t.lastAccessedAt=new Date().toISOString(),await this.saveLessonPlan(t))}async deleteLessonPlan(e){const t=await this.ensureDB();return new Promise((n,r)=>{const o=t.transaction([this.storeName],"readwrite").objectStore(this.storeName).delete(e);o.onsuccess=()=>n(),o.onerror=()=>r(new Error("Failed to delete lesson plan"))})}async searchLessonPlans(e){const t=await this.getAllLessonPlans(),n=e.toLowerCase();return t.filter(r=>r.topic.toLowerCase().includes(n))}async getSharedLessonPlans(){return(await this.getAllLessonPlans()).filter(t=>t.metadata?.isShared===!0)}async getLocalLessonPlans(){return(await this.getAllLessonPlans()).filter(t=>!t.metadata?.isShared)}async cleanupOldLessonPlans(e=50){const t=await this.getAllLessonPlans();if(t.length>e){const n=t.slice(e);for(const r of n)await this.deleteLessonPlan(r.id)}}async getStorageStats(){const e=await this.getAllLessonPlans();return{totalCount:e.length,totalSizeEstimate:JSON.stringify(e).length,oldestPlan:e[e.length-1]?.topic,newestPlan:e[0]?.topic}}}const It=new Ve,We=()=>{const s=Date.now(),e=Math.random().toString(36).substr(2,9);return`lesson_${s}_${e}`},Rt=(s,e)=>{const t=new Date().toISOString();return{id:We(),topic:s,createdAt:t,lastAccessedAt:t,content:e,metadata:{totalSections:[e.learningObjectives,e.contentBreakdown,e.confusingPoints,e.classroomActivities,e.quiz,e.writingPractice].filter(Boolean).length,hasQuiz:!!e.quiz,hasWriting:!!e.writingPractice}}};class W{static async encrypt(e,t){try{const n=crypto.getRandomValues(new Uint8Array(16)),r=await crypto.subtle.importKey("raw",new TextEncoder().encode(t),{name:"PBKDF2"},!1,["deriveKey"]),i=await crypto.subtle.deriveKey({name:"PBKDF2",salt:n,iterations:1e5,hash:"SHA-256"},r,{name:"AES-GCM",length:256},!1,["encrypt"]),a=crypto.getRandomValues(new Uint8Array(12)),o=await crypto.subtle.encrypt({name:"AES-GCM",iv:a},i,new TextEncoder().encode(e)),c=new Uint8Array(n.length+a.length+o.byteLength);return c.set(n,0),c.set(a,n.length),c.set(new Uint8Array(o),n.length+a.length),btoa(String.fromCharCode(...c))}catch(n){throw console.error("加密失敗:",n),new Error("加密數據失敗")}}static async decrypt(e,t){try{const n=new Uint8Array(atob(e).split("").map(u=>u.charCodeAt(0))),r=n.slice(0,16),i=n.slice(16,28),a=n.slice(28),o=await crypto.subtle.importKey("raw",new TextEncoder().encode(t),{name:"PBKDF2"},!1,["deriveKey"]),c=await crypto.subtle.deriveKey({name:"PBKDF2",salt:r,iterations:1e5,hash:"SHA-256"},o,{name:"AES-GCM",length:256},!1,["decrypt"]),l=await crypto.subtle.decrypt({name:"AES-GCM",iv:i},c,a);return new TextDecoder().decode(l)}catch(n){throw console.error("解密失敗:",n),new Error("解密數據失敗 - 請檢查密碼是否正確")}}static generateRandomPassword(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*";let t="";for(let n=0;n<16;n++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}static validatePasswordStrength(e){const t=[];let n=0;return e.length<8?t.push("密碼長度至少需要 8 個字符"):n+=1,/[a-z]/.test(e)?n+=1:t.push("需要包含小寫字母"),/[A-Z]/.test(e)?n+=1:t.push("需要包含大寫字母"),/[0-9]/.test(e)?n+=1:t.push("需要包含數字"),/[!@#$%^&*()_+\-=[\]{};':"\\|,.<>/?]/.test(e)?n+=1:t.push("建議包含特殊字符"),{isValid:n>=3,score:n,feedback:t}}}const R="https://api.jsonbin.io/v3",j="$2a$10$0PieG5Wm.V.6svtN4PbaTuVxU4LY0nL2Vaz4N3g2aYlb0cL1NG4Qa";class jt{static async createEncryptedShare(e,t,n,r){try{const i={providers:e.map(u=>({type:u.type,name:u.name,model:this.getProviderModel(u),apiKey:u.apiKey,settings:this.getProviderSettings(u),description:u.description})),sharedAt:new Date().toISOString()},a=await W.encrypt(JSON.stringify(i),n),o={id:`encrypted_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,name:t,description:r,encryptedData:a,metadata:{version:"1.0",createdAt:new Date().toISOString(),providerTypes:[...new Set(e.map(u=>u.type))],providerCount:e.length,hasEncryption:!0}},c=await fetch(`${R}/b`,{method:"POST",headers:{"Content-Type":"application/json","X-Master-Key":j},body:JSON.stringify(o)});if(!c.ok){const u=await c.text();throw new Error(`上傳失敗: ${c.statusText} - ${u}`)}return(await c.json()).metadata.id}catch(i){throw console.error("創建加密分享失敗:",i),i}}static createLegacyShare(e){return`${window.location.origin}/ai-page-gen/?apikey=${encodeURIComponent(e)}`}static async loadEncryptedShare(e,t){try{const n=await fetch(`${R}/b/${e}/latest`,{headers:{"X-Master-Key":j}});if(!n.ok){const o=await n.text();throw new Error(`載入失敗: ${n.statusText} - ${o}`)}const i=(await n.json()).record;if(!i.metadata?.hasEncryption)throw new Error("這不是一個加密的分享配置");const a=await W.decrypt(i.encryptedData,t);return JSON.parse(a)}catch(n){throw console.error("載入加密分享失敗:",n),n}}static async getSharePreview(e){try{const t=await fetch(`${R}/b/${e}/latest`,{headers:{"X-Master-Key":j}});if(!t.ok){const i=await t.text();throw new Error(`載入預覽失敗: ${t.statusText} - ${i}`)}const r=(await t.json()).record;return{name:r.name,description:r.description,providerTypes:r.metadata.providerTypes,providerCount:r.metadata.providerCount,createdAt:r.metadata.createdAt,hasEncryption:r.metadata.hasEncryption}}catch(t){throw console.error("獲取分享預覽失敗:",t),t}}static generateShareUrl(e){return`${window.location.origin}/ai-page-gen/?provider_share=${encodeURIComponent(e)}`}static parseShareUrl(){const e=new URLSearchParams(window.location.search),t=e.get("provider_share");if(t)return{type:"provider",value:t};const n=e.get("apikey");return n?{type:"legacy",value:n}:{type:null,value:null}}static getProviderModel(e){return e.type==="gemini"?e.model||"gemini-2.5-flash":e.type==="openrouter"?e.model||"openai/gpt-4o":"unknown"}static getProviderSettings(e){return e.type==="gemini"?e.settings||{}:e.type==="openrouter"?e.settings||{}:{}}static validateShareData(e){const t=[];return!e.providers||!Array.isArray(e.providers)?t.push("無效的 providers 數據"):e.providers.forEach((n,r)=>{n.type||t.push(`Provider ${r+1}: 缺少類型`),n.name||t.push(`Provider ${r+1}: 缺少名稱`),n.apiKey||t.push(`Provider ${r+1}: 缺少 API Key`),n.model||t.push(`Provider ${r+1}: 缺少模型`)}),e.sharedAt||t.push("缺少分享時間"),{isValid:t.length===0,errors:t}}static createProviderConfigsFromShare(e,t="分享的"){return e.providers.map((n,r)=>{const i={id:`shared_${Date.now()}_${r}`,name:`${t} ${n.name}`,type:n.type,enabled:!0,apiKey:n.apiKey,description:n.description||`從分享匯入的 ${n.type} 配置`,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return n.type==="gemini"?{...i,model:n.model,settings:n.settings||{responseMimeType:"application/json",temperature:.7,maxOutputTokens:8192}}:n.type==="openrouter"?{...i,model:n.model,settings:n.settings||{temperature:.7,max_tokens:8192}}:i})}static generateShareStats(e){const t={};return e.forEach(n=>{t[n.type]=(t[n.type]||0)+1}),{totalProviders:e.length,providerTypes:t,estimatedCost:"免費",securityLevel:"high"}}}const x=new te({max:50,ttl:1e3*60*60}),Mt=async(s,e)=>{if(!e)throw new Error("API Key is required");if(x.has(s)){console.log("Serving from cache:",s.substring(0,50)+"...");const r=x.get(s);try{return JSON.parse(r)}catch(i){console.error("Failed to parse cached JSON:",i),x.delete(s)}}const t=new z({apiKey:e}),n="gemini-1.5-flash";try{const r=await t.models.generateContent({model:n,contents:[{role:"user",parts:[{text:s}]}],config:{responseMimeType:"application/json"}});if(!r.text)throw new Error("AI 回傳內容為空，請重試或檢查 API 金鑰。");let i=r.text.trim();x.set(s,i);const a=/^```(\w*)?\s*\n?(.*?)\n?\s*```$/s,o=i.match(a);if(o&&o[2]&&(i=o[2].trim()),!i.startsWith("{")&&!i.startsWith("[")&&(i.includes("{")||i.includes("["))){const c=i.indexOf("{"),l=i.indexOf("[");let u=-1,d=-1;c!==-1&&(l===-1||c<l)?(u=c,d=i.lastIndexOf("}")):l!==-1&&(u=l,d=i.lastIndexOf("]")),u!==-1&&d!==-1&&d>u&&(i=i.substring(u,d+1))}try{return JSON.parse(i)}catch{throw console.error("AI 回傳原始內容 (JSON parse 失敗):",r.text),new Error("AI 模型傳回的資料格式無法解析 (可能不是有效的 JSON)。請嘗試修改您的主題或重試。")}}catch(r){let i="無法產生內容。";if(r instanceof Error&&(i+=` 詳細資料： ${r.message}`),r&&typeof r=="object"&&"message"in r){const a=r;a.message.includes("API key not valid")||a.message.includes("API_KEY_INVALID")?i="Gemini API 金鑰無效。請檢查您的設定。":a.message.includes("quota")||a.message.includes("RESOURCE_EXHAUSTED")?i="已超出 API 配額。請稍後再試。":(a.message.toLowerCase().includes("json")||a.message.includes("Unexpected token"))&&(i="AI 模型傳回的資料格式無法解析 (可能不是有效的 JSON)。請嘗試修改您的主題或重試。")}throw console.error("Gemini API Error:",r),new Error(i)}};class ze{constructor(){this.dbName="InteractiveContentDB",this.version=1,this.db=null}async init(){if(!this.db)return new Promise((e,t)=>{const n=indexedDB.open(this.dbName,this.version);n.onerror=()=>{t(new Error("Failed to open InteractiveContent database"))},n.onsuccess=()=>{this.db=n.result,e()},n.onupgradeneeded=r=>{const i=r.target.result;if(!i.objectStoreNames.contains("interactiveContent")){const a=i.createObjectStore("interactiveContent",{keyPath:"lessonPlanId"});a.createIndex("topic","topic",{unique:!1}),a.createIndex("lastAccessedAt","lastAccessedAt",{unique:!1})}}})}ensureDB(){if(!this.db)throw new Error("Database not initialized. Call init() first.");return this.db}async saveVersion(e,t,n,r,i,a){console.log("=== interactiveContentStorage.saveVersion 開始 ==="),console.log("參數:",{lessonPlanId:e,topic:t,transformedData:n,selectedSteps:r,versionName:i,description:a});try{const o=this.ensureDB();console.log("✅ 獲取資料庫連接成功");const c=`version_${Date.now()}`,l=new Date().toISOString();return console.log("生成版本ID:",c),new Promise((u,d)=>{const g=o.transaction(["interactiveContent"],"readwrite"),p=g.objectStore("interactiveContent");console.log("✅ 開始資料庫事務");const f=p.get(e);console.log("查詢現有記錄:",e),f.onsuccess=()=>{console.log("✅ 查詢現有記錄成功");const m=f.result;console.log("現有記錄:",m?`存在，包含 ${m.versions.length} 個版本`:"不存在");const C={id:c,name:i||`版本 ${l.slice(0,19).replace("T"," ")}`,description:a,createdAt:l,lastModifiedAt:l,transformedData:n,selectedSteps:r};console.log("新版本物件:",C);const U={lessonPlanId:e,topic:t,versions:m?[...m.versions,C]:[C],lastAccessedAt:l};console.log("準備保存記錄:",U);const T=p.put(U);T.onsuccess=()=>{console.log("✅ 版本保存成功"),u(c)},T.onerror=Z=>{console.error("❌ 保存版本失敗:",Z),console.error("putRequest.error:",T.error),d(new Error(`Failed to save interactive content version: ${T.error?.message||"Unknown error"}`))}},f.onerror=m=>{console.error("❌ 查詢現有記錄失敗:",m),console.error("getRequest.error:",f.error),d(new Error(`Failed to get existing interactive content: ${f.error?.message||"Unknown error"}`))},g.onerror=m=>{console.error("❌ 資料庫事務失敗:",m),d(new Error(`Database transaction failed: ${g.error?.message||"Unknown error"}`))}})}catch(o){throw console.error("❌ interactiveContentStorage.saveVersion 異常:",o),o}}async getVersions(e){const t=this.ensureDB();return new Promise((n,r)=>{const o=t.transaction(["interactiveContent"],"readonly").objectStore("interactiveContent").get(e);o.onsuccess=()=>{const c=o.result;n(c?c.versions:[])},o.onerror=()=>{r(new Error("Failed to get interactive content versions"))}})}async getVersion(e,t){return(await this.getVersions(e)).find(r=>r.id===t)||null}async updateVersion(e,t,n){const r=this.ensureDB();return new Promise((i,a)=>{const c=r.transaction(["interactiveContent"],"readwrite").objectStore("interactiveContent"),l=c.get(e);l.onsuccess=()=>{const u=l.result;if(!u){a(new Error("Interactive content record not found"));return}const d=u.versions.findIndex(p=>p.id===t);if(d===-1){a(new Error("Version not found"));return}u.versions[d]={...u.versions[d],...n,lastModifiedAt:new Date().toISOString()};const g=c.put(u);g.onsuccess=()=>i(),g.onerror=()=>a(new Error("Failed to update version"))},l.onerror=()=>{a(new Error("Failed to get interactive content"))}})}async deleteVersion(e,t){const n=this.ensureDB();return new Promise((r,i)=>{const o=n.transaction(["interactiveContent"],"readwrite").objectStore("interactiveContent"),c=o.get(e);c.onsuccess=()=>{const l=c.result;if(!l){i(new Error("Interactive content record not found"));return}if(l.versions=l.versions.filter(u=>u.id!==t),l.versions.length===0){const u=o.delete(e);u.onsuccess=()=>r(),u.onerror=()=>i(new Error("Failed to delete record"))}else{const u=o.put(l);u.onsuccess=()=>r(),u.onerror=()=>i(new Error("Failed to update record"))}},c.onerror=()=>{i(new Error("Failed to get interactive content"))}})}async getAllRecords(){const e=this.ensureDB();return new Promise((t,n)=>{const a=e.transaction(["interactiveContent"],"readonly").objectStore("interactiveContent").getAll();a.onsuccess=()=>{t(a.result)},a.onerror=()=>{n(new Error("Failed to get all interactive content records"))}})}async updateLastAccessed(e){const t=this.ensureDB();return new Promise((n,r)=>{const a=t.transaction(["interactiveContent"],"readwrite").objectStore("interactiveContent"),o=a.get(e);o.onsuccess=()=>{const c=o.result;if(c){c.lastAccessedAt=new Date().toISOString();const l=a.put(c);l.onsuccess=()=>n(),l.onerror=()=>r(new Error("Failed to update last accessed time"))}else n()},o.onerror=()=>{r(new Error("Failed to get interactive content"))}})}}const Dt=new ze;class Ke{constructor(){this.synthesis=null,this.recognition=null,this.isRecording=!1,this.initializeSpeechSynthesis(),this.initializeSpeechRecognition()}initializeSpeechSynthesis(){"speechSynthesis"in window&&(this.synthesis=window.speechSynthesis)}isTTSSupported(){return this.synthesis!==null}getAvailableVoices(){return this.synthesis?this.synthesis.getVoices().filter(e=>e.lang.startsWith("en")):[]}speak(e,t={},n,r,i){return new Promise((a,o)=>{if(!this.synthesis){o(new Error("Text-to-Speech not supported in this browser"));return}this.synthesis.cancel();const c=new SpeechSynthesisUtterance(e),u={...{lang:"en-US",rate:1,pitch:1,volume:1},...t};c.lang=u.lang,c.rate=u.rate,c.pitch=u.pitch,c.volume=u.volume;const d=this.getAvailableVoices(),g=d.find(p=>p.lang===u.lang&&!p.name.includes("Google"))||d.find(p=>p.lang===u.lang)||d[0];g&&(c.voice=g),c.onstart=()=>{n?.()},c.onend=()=>{r?.(),a()},c.onerror=p=>{i?.(p),o(p)},this.synthesis.speak(c)})}stopSpeaking(){this.synthesis&&this.synthesis.cancel()}pauseSpeaking(){this.synthesis&&this.synthesis.pause()}resumeSpeaking(){this.synthesis&&this.synthesis.resume()}isSpeaking(){return this.synthesis?.speaking||!1}initializeSpeechRecognition(){const e=window.SpeechRecognition||window.webkitSpeechRecognition||window.mozSpeechRecognition||window.msSpeechRecognition;e&&(this.recognition=new e)}isSTTSupported(){return this.recognition!==null}startRecording(e={},t,n,r,i){return new Promise((a,o)=>{if(!this.recognition){o(new Error("Speech recognition not supported in this browser"));return}if(this.isRecording){o(new Error("Already recording"));return}const l={...{lang:"en-US",continuous:!1,interimResults:!0,maxAlternatives:3},...e};this.recognition.lang=l.lang,this.recognition.continuous=l.continuous,this.recognition.interimResults=l.interimResults,this.recognition.maxAlternatives=l.maxAlternatives,this.recognition.onstart=()=>{this.isRecording=!0,r?.()},this.recognition.onresult=u=>{for(let d=u.resultIndex;d<u.results.length;d++){const g=u.results[d][0].transcript,p=u.results[d][0].confidence;t?.({text:g,confidence:p||.8,isFinal:u.results[d].isFinal})}},this.recognition.onerror=u=>{this.isRecording=!1,n?.(u),o(u)},this.recognition.onend=()=>{this.isRecording=!1,i?.(),a()};try{this.recognition.start()}catch(u){this.isRecording=!1,o(u)}})}stopRecording(){this.recognition&&this.isRecording&&this.recognition.stop()}isCurrentlyRecording(){return this.isRecording}analyzePronunciation(e,t){const n=e.toLowerCase().split(/\s+/),r=t.toLowerCase().split(/\s+/),i=[],a=[];n.forEach(l=>{const u=l.replace(/[.,!?;:]/g,"");r.some(d=>d.replace(/[.,!?;:]/g,"").includes(u)||u.includes(d.replace(/[.,!?;:]/g,"")))?i.push(l):a.push(l)});const o=n.length>0?i.length/n.length*100:0,c=[];return o<70&&c.push("Try speaking more slowly and clearly"),a.length>0&&c.push(`Practice these words: ${a.slice(0,3).join(", ")}`),t.length<e.length*.5&&c.push("Speak louder and closer to the microphone"),{accuracy:Math.round(o),suggestions:c,matchedWords:i,missedWords:a}}getSupportStatus(){const e=navigator.userAgent;let t="Unknown browser";return e.includes("Chrome")?t="Chrome":e.includes("Firefox")?t="Firefox":e.includes("Safari")?t="Safari":e.includes("Edge")&&(t="Edge"),{ttsSupported:this.isTTSSupported(),sttSupported:this.isSTTSupported(),browserInfo:t}}}const _t=new Ke;export{et as $,Ae as A,Ee as B,Ce as C,Pe as D,xe as E,Ne as F,ke as G,Ie as H,D as I,pt as J,ht as K,gt as L,Mt as M,Ze as N,It as O,Xe as P,Dt as Q,ct as R,at as S,nt as T,xt as U,it as V,Nt as W,kt as X,_e as Y,Tt as Z,Pt as _,vt as a,w as a0,ae as a1,oe as a2,O as a3,b as a4,y as a5,S as a6,W as a7,jt as a8,Rt as a9,M as aa,Ue as ab,st as ac,tt as ad,rt as ae,se as af,_t as ag,ot as ah,wt as b,yt as c,$t as d,h as e,bt as f,mt as g,St as h,ft as i,ut as j,lt as k,Et as l,At as m,Ot as n,Ct as o,A as p,de as q,ge as r,he as s,dt as t,me as u,fe as v,ye as w,ve as x,be as y,$e as z};
